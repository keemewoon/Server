	...
	public static void main(String[] args) {
		...
		*/
		...
		try {
			...
			// - SQL 사용 -> 문자열 취급
			// - 문자열로 SQL을 미리 준비한다.
			//String sql = "insert into tblAddress(seq, name, age, gender, address) values(seqAddress.nextVal, '홍길동', 21, 'f', '서울시 종로구 동대문로')";

			String sql = "update tblAddress set age = age + 1 where name ='하하하'";
			...
			int result = stat.executeUpdate(sql); //SQL에서 Ctrl + Enter와 동일한 행동, 쿼리 실행(***)
