...
<body>
	...
	<div class="container">
		...
		<!-- 
			...
			텍스트 7000자 전송 -> 에러 -> 7000B -> 7KB
		
			파일 업로드 규칙
			1. <form> 태그의 method를 반드시 "POST"를 사용한다.
			2. <input type="file">을 사용한다.
			3. <form>태그 속성에 enctype="multipart/form-data" 속성을 추가한다.
				-enctype(인코딩 타입: 폼태그가 서버로 데이터를 전송할 때 사용할 인코딩 방식)
				a. application/x-www-form-urlencoded: 기본값. 문자열만 전송
				b. multipart/form-data: 비문자열까지 같이 전송(첨부파일 전송)
